...
Supports all HuggingFace Transformers models including popular architectures:
- LLaMA 2 (Meta AI)
- Mistral AI models
- Google Gemma
- Alibaba Qwen/Qwen2
    ...
    return {
        ...
        "medium_performance": [
            ...
            (
                ...
                "Phi-3: Microsoft's instruction-tuned model",
            ),
        ...
        "code_models": [
            ...
            (
                ...
                "CodeGen: Salesforce code generation model",
            ),
    ...
    try:
        ...
        if (
            any(
                ...
                for pattern in ["llama", "mistral", "falcon"]
            )
            and "7b" in model_id.lower()
        ):
            warnings.append("⚠️  Large model (7B+) - ensure sufficient RAM/VRAM")

        if "instruct" in model_id.lower() or "chat" in model_id.lower():
            warnings.append(
                "💡 Instruction-tuned model - may work better with specific prompts"
            )
