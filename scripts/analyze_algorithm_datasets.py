...
def analyze_algorithms():
    ...
    try:
        ...
        print(f"✅ Dataset-backed: {dataset_backed} ({dataset_backed/total_algorithms*100:.1f}%)")
        print(f"⚠️  Heuristic-only: {heuristic_only} ({heuristic_only/total_algorithms*100:.1f}%)")
        print(f"🔧 Available but not integrated: {available_but_not_integrated} ({available_but_not_integrated/total_algorithms*100:.1f}%)")
        print()
